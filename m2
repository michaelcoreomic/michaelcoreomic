...
--Rayfield.Main.Topbar.Theme.ImageTransparency = 1
--Rayfield.Main.Topbar.Theme.Image = 0
--Rayfield.Main.Topbar.Hide.ImageTransparency = 1
--Rayfield.Main.Topbar.Hide.Image = 1
--Rayfield.Main.Topbar.Hide.Parent = nil
--Rayfield.Main.Topbar.Theme.Parent = nil
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name,Image)
		...
		--Adaptive input
		function Tab:CreateAdaptiveInput(InputSettings)
			local Input = Elements.Template.Input:Clone()
			Input.Name = InputSettings.Name
			Input.Title.Text = InputSettings.Name
			Input.Visible = true
